            ...
            <li class="nav-item dropdown profile-nav-item">
                <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true"
                    ...
                    <div class="menu-profile">
                        ...
                        <?php if($_SESSION["usu_img"] != null){ ?>
                            <img src="..\..\public\img\users\<?php echo $_SESSION["usu_img"]; ?>" class="rounded-circle" alt="image">
                        <?php }else{ ?>
                            <img src="..\..\public\img\users\70x70.jpg" class="rounded-circle" alt="image">
                        <?php } ?>
                    </div>
                </a>
